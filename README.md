...
4. Make the `client/src/tailwind.css` file by doing `tailwindcss -o client/src/tailwind.css`.
...
4. Run `trunk serve --release` to run the frontend (you can also add the `--open` to open the URL in your default browser).
